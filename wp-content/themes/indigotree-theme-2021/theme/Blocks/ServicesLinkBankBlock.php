...
class ServicesLinkBankBlock extends Block
{
    /**
     ...
     * @var string
     */
    protected $unique = 'services-link-bank-block';
     ...
     * @var string
     */
    protected $title = 'Service Link Bank Block';
    ...
    {
        get_template_part('template-parts/blocks/services-link-bank-block');
    }
