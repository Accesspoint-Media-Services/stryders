...
namespace IndigoTree\AmendedNavWalker;

use IndigoTree\BootstrapNavWalker\BaseWalkerNavMenu;

class AmendedWalkerNavMenu extends BaseWalkerNavMenu
{
    /**
    ...
    public function start_el(&$output, $item, $depth = 0, $args = [], $id = 0)
    {
        ...
        $item_output .= $args->has_children && 0 === $depth && $args->depth > 1 ? ' tabindex="0"' : '';
        $item_output .= '>';
